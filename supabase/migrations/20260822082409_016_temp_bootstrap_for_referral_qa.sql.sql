/*
# Temporary admin bootstrap function (re-created for referral QA)

## Overview
Same secret-protected bootstrap as migration 013, re-created for the referral
reward QA pass. Will be dropped again after testing.
*/
